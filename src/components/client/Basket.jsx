  ...
  return (
    <div>
      <div className="container h-screen pt-20">
        <h1 className="container mx-auto max-w-7xl px-2 text-2xl font-bold">
          Ssavatga olingan mahsulotlar soni: {data?.length}{" "}
        </h1>

        <div className="mx-auto justify-center px-6 md:flex md:space-x-6 xl:px-0">
          <div className="rounded-lg md:w-2/3 p-4 flex flex-col gap-2 h-[75vh] overflow-x-auto">
            {data?.map((value) => {
              return (
                <>
